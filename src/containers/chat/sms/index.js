            ...
            <div className="content-body pd-0">
                <div className="chat-wrapper chat-wrapper-two">
                    ...
                    <div className="chat-content">
                        <ChatHead User={User} backgroundColor={'#02e84c'} toggleMode={this.toggleMode} ghostMode={ghostMode} />
                        <div className="chat-content-body">
                            <div className="chat-group background-image" style={{ backgroundImage: "url('./imessage.png')" }} >
                                ...
                                {
                                    Chats.map((item) => (
                                        <MessageCard data={item} backgroundColor={'#02e84c'} />
                                    ))
                                }
                            </div>
                        </div>
...
export default connect(mapStateToProps, { setCurrentRoute })(SMS);