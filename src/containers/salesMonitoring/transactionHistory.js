    ...
    return (
        <li class="list-group-item d-flex pd-sm-x-20">
            ...
            <div class="pd-sm-l-10">
                <p class="tx-medium mg-b-0">{activity} from #{userId}</p>
                <small class="tx-12 tx-color-03 mg-b-0">{date}</small>
            </div>
            <div class="mg-l-auto text-right">
                <p class="tx-medium mg-b-0">${ amount}</p>
                <small class="tx-12 tx-success mg-b-0">{status}</small>
            </div>
        </li>
    )
}
